...
public class CustomerDetailsResource {
    ...
    public ResponseEntity<List<CustomerDetails>> getAllCustomerDetails(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
