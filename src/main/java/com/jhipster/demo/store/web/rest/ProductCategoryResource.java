...
public class ProductCategoryResource {
    ...
    public ResponseEntity<List<ProductCategory>> getAllProductCategories(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
